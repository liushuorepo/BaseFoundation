...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of BaseFoundation.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/13124832031@163.com/BaseFoundation'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '13124832031@163.com' => 'liushuo@alaxiaoyou.com' }
  s.source           = { :git => 'https://github.com/13124832031@163.com/BaseFoundation.git', :tag => s.version.to_s }
